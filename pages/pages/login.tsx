...
export const getStaticProps: GetStaticProps = async () => ({ props: { title: 'Login', description: 'Sign in to your Immigrants Alliance account to access programs, services, and your dashboard.' } });
    ...
    <section className="bg-warm min-h-[80vh] flex items-center justify-center py-16">
      <div className="max-w-md w-full mx-auto px-6">
        <div className="bg-white rounded-2xl p-8 md:p-10" style={{ boxShadow: '0 4px 20px rgba(10,22,40,.12)' }}>
          ...
          <div className="text-center mt-6 text-sm text-gray-500">Don&apos;t have an account? <Link href="/register" className="text-teal font-semibold hover:underline">Create one →</Link></div>
        </div>
      </div>
    </section>
  );

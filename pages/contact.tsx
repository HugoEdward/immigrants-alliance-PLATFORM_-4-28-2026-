...
export const getStaticProps: GetStaticProps = async () => ({ props: { title: 'Contact', breadcrumbs: [{ name: 'Contact', href: '/contact' }], description: 'Contact Immigrants Alliance for membership, programs, partnerships, parade registration, and general inquiries. Serving immigrant communities in 190+ countries.' } });

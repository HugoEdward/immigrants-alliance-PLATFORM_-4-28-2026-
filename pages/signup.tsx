...
export const getStaticProps: GetStaticProps = async () => ({ props: { title: 'Sign Up', description: 'Create your free Immigrants Alliance account. Access immigration consultation, legal referrals, MundusPass discounts, and events worldwide.' } });

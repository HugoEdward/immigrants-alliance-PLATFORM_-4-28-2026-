...
export const getStaticProps: GetStaticProps = async () => ({ props: { title: 'About', breadcrumbs: [{ name: 'About', href: '/about' }], description: 'Founded in 1976, Immigrants Alliance has spent nearly five decades building bridges between cultures and empowering immigrant communities across 190+ countries. UN ECOSOC Consultative Status since 1989.' } });

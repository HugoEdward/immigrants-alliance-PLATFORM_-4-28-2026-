...
export const getStaticProps: GetStaticProps = async () => ({ props: { title: 'Register Organization', breadcrumbs: [{ name: 'Register', href: '/register' }, { name: 'Organization', href: '/register-organization' }], description: 'Register your organization with Immigrants Alliance. Access S.E.E.D. benefits managed by Mundus.Center, free International Cultures Celebration participation, and international recognition.' } });
    ...
    <>
      <section className="relative overflow-hidden text-white text-center py-16">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6">
          ...
          <p className="text-lg opacity-85">Join the global Alliance. $100/month or $1,000/year, processed through MundusPASS.</p>
        </div>
      </section>
      <section className="bg-warm py-16">
        <div className="max-w-3xl mx-auto px-6">
          {/* Grant message */}
          <div className="bg-teal/5 border border-teal/15 rounded-xl p-5 mb-8 text-center">
